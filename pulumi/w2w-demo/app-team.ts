...
export const webWorkloadID = new teleport.WorkloadIdentity(
  "w2w-demo-web",
  {
    version: "v1",
    metadata: {
...
export const backend1WorkloadID = new teleport.WorkloadIdentity(
  "w2w-demo-backend-1",
  {
    version: "v1",
    metadata: {
...
export const backend2WorkloadID = new teleport.WorkloadIdentity(
  "w2w-demo-backend-2",
  {
    version: "v1",
    metadata: {
...
export const appBotWebRole = new teleport.Role(
  "w2w-demo-app-bot-web",
  {
    version: "v7",
    metadata: {
...
export const appBotBackend1Role = new teleport.Role(
  "w2w-demo-app-bot-backend-1",
  {
    version: "v7",
    metadata: {
...
export const appBotBackend2Role = new teleport.Role(
  "w2w-demo-app-bot-backend-2",
  {
    version: "v7",
    metadata: {
...
export const appBot = new teleport.Bot(
  "w2w-demo-app",
  {
...
export const appBotIAMJoinToken = new teleport.ProvisionToken(
  "w2w-demo-web-bot",
  {
    version: "v2",
    metadata: {
...
export const appBotK8sJoinToken = new teleport.ProvisionToken(
  "w2w-demo-web-backend",
  {
    version: "v2",
    metadata: {
    ...
    spec: {
      ...
      kubernetes: {
        ...
        staticJwks: {
          jwks: fetch(
            "https://oidc.eks.us-west-2.amazonaws.com/id/3930A6E36DE6AC70C1F1E99B3CFA9EF6/keys",
          ).text(),
        },
        allows: [
          {
