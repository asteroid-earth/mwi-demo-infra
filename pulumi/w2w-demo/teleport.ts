...
export const instanceJoinToken = new teleport.ProvisionToken("w2w-demo-instance", {
  version: "v2",
  metadata: {
...
export const deploymentBotWorkloadID = new teleport.WorkloadIdentity("w2w-demo-deployment-bot", {
  version: "v1",
  metadata: {
...
export const deploymentBotRole = new teleport.Role("w2w-demo-deployment-bot", {
  version: "v7",
  metadata: {
...
export const deploymentBot = new teleport.Bot("w2w-demo-deployment", {
  name: "w2w-demo-deployment",
  roles: ["w2w-demo-deployment-bot"]
}, { provider: teleportProvider })

export const deploymentJoinToken = new teleport.ProvisionToken("w2w-demo-deployment", {
  version: "v2",
  metadata: {
    name: "w2w-demo-deployment",
  },
