...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("teleport");
			params.setVersion("17.4.7");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoidGVycmFmb3JtLnJlbGVhc2VzLnRlbGVwb3J0LmRldi9ncmF2aXRhdGlvbmFsL3RlbGVwb3J0IiwidmVyc2lvbiI6IjE3LjQuNyJ9fQ=="), c => c.charCodeAt(0)));
