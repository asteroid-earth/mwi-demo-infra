...
export const ansibleJoinToken = new teleport.ProvisionToken(
  "mwi-demo-ansible",
  {
    version: "v2",
    metadata: {
      ...
      allows: [
        {
          awsAccount: "668558765449",
          awsArn:
            "arn:aws:sts::668558765449:assumed-role/MWIDemoInstance/i-08e162d4dc454ccea",
        },
      ],
    },
  },
...
export const ansibleBotRole = new teleport.Role(
  "mwi-demo-ansible",
  {
    version: "v7",
    metadata: {
...
export const ansibleBot = new teleport.Bot(
  "mwi-demo-ansible",
  {
    name: "mwi-demo-ansible",
